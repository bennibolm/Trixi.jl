        ...
        for i in eachnode(dg)
            ...
            for small_element_index in 1:2
                ...
                for j in eachnode(dg)
                    ...
                    weight = mortar_weights[j, i, small_element_index]
                    ...
                    lambda = max_abs_speed_naive(u_small, u_large,
                                                 ...
                                                 equations)
                    lambda_small = weight * lambda / mortar_weights_sums[i, 1]
...
function calc_mortar_flux_low_order!(surface_flux_values,
    ...
    # to map the mortar node to the large-element face (using `get_large_surface_index`) since its orientation
        ...
        for i in eachnode(dg)
            for small_element_index in 1:2
                ...
                for j in eachnode(dg)
                    ...
                    j_mortar = get_large_surface_index(large_indices, i_large, j_large)
