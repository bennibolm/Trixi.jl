...
@trixi_testset "elixir_euler_density_wave_nonconforming_idp_mortars.jl" begin
    @test_trixi_include(joinpath(EXAMPLES_DIR,
...
@trixi_testset "elixir_euler_blast_wave_nonconforming_sc_subcell.jl" begin
